<?php
// filepath: views/templates/sidebar_warga.php
?>
<aside class="fixed top-0 left-0 h-full w-64 bg-gradient-to-b from-blue-600 to-purple-600 shadow-lg flex flex-col z-30">
    ...
    <nav class="flex-1 px-4">
        <ul class="space-y-2">
            <li>
                <a href="../warga/warga_dashboard.php" class="flex items-center px-4 py-2 rounded-lg text-white hover:bg-blue-700 transition">
